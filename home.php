		  ...
		  <form class="formValidate" id="formValidate" method="post" action="place-order.php" novalidate="novalidate">
            <div class="row">
              ...
              <div>
				...
				{
					echo '<tr><td>'.$row["name"].'</td><td>'.$row["price"].'</td><td>'.$row["food_details"].'</td>';
			  ...
			  <div>
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Login or Register Now to Order
