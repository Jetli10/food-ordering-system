        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/foodnetwork-logo.png" alt="logo" style= "width: 48px; heighth: 28px;">FOOD NETWORK</a></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
            ...
            <div class="row">
              ...
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><div class="input-field col s12 "><label for="'.$row["id"].'_food_details">Food Details</label>';
					echo '<input value="'.$row["food_details"].'" id="'.$row["id"].'_food_details" name="'.$row['id'].'_food_details" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>';
...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="name">Item Price/Piece</th>
												<th data-field="food_details">Food Details</th>
                      </tr>
                    </thead>
				...
				<?php
					...
					echo '<td><div class="input-field col s12"><label for="food_details">Food Details</label>';
					echo '<input id="food_details" name="food_details" type="text" data-error=".errorTxt03"><div class="errorTxt03"></div></td>';
					echo '<td></tr>';
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2019 <a class="grey-text text-lighten-4" href="#" target="_blank">Foodee Inc.</a> All rights reserved.</span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
